...
def main():
  ...
  def mainRender(needsRender, menu, selection):
    ...
    if needsRender == 1:
      ...
      print(term.black_on_cornsilk4(term.center('IOTstack RuTorrent Options')))
      print("")
...
global currentServiceName # Name of the current service
if currentServiceName == 'rutorrent_iot':
  main()
else:
  print("Error. '{}' Tried to run 'rutorrent_iot' config".format(currentServiceName))
